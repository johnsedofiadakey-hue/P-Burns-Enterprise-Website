...
export default function WhatsAppFloat() {
  ...
  useEffect(() => {
    const fetchSettings = async () => {
      try {
        ...
        console.error("Error fetching settings for WhatsApp float:", error);
      }
    };
    fetchSettings();
  }, []);
  ...
  return (
    ...
    >
      ...
      <span className="absolute right-full mr-3 bg-[#111111] text-white text-xs font-bold py-2 px-3 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap shadow-xl">
        Chat with us
      </span>
    </a>
  )
