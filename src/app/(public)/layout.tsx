...
export default async function PublicLayout({
  ...
  try {
    const snap = await getDocFromServer(doc(db, "settings", "general"))
    if (snap.exists()) {
      ...
      <footer className="bg-[#111111] text-white mt-auto border-t border-[#1A1A1A]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            <div>
              <div className="mb-4">
                <Image src="/logo-transparent.png" alt="P-Burns Logo" width={100} height={33} className="object-contain invert brightness-0" style={{ height: 'auto' }} />
              </div>
              <p className="text-gray-400 text-sm leading-relaxed mb-6">Premium ceramics, luxury doors, and enterprise construction supplies sourced directly from top global manufacturers.</p>
              ...
              <div className="flex space-x-4">
                ...
                <a href={settings.tiktokUrl || '#'} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-5.2 1.74 2.89 2.89 0 012.31-4.64 2.93 2.93 0 01.88.13V9.4a6.84 6.84 0 00-1-.05A6.33 6.33 0 005 20.1a6.34 6.34 0 0010.86-4.43v-7a8.16 8.16 0 004.77 1.52v-3.4a4.85 4.85 0 01-1.04-.1z" />
                  </svg>
                </a>
                <a href={settings.whatsappUrl || '#'} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
