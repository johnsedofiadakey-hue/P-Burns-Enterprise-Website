...
export default function OrderDetailPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="mb-6">
        <Link href="/admin/orders" className="text-emerald-600 hover:text-emerald-700 font-medium">&larr; Back to Orders</Link>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
        ...
        <div className="border-t border-gray-100 mt-6 pt-6 flex justify-end">
          <div className="text-right">
            ...
            <p className="text-2xl font-bold text-emerald-600">GH₵ {order.total.toFixed(2)}</p>
          </div>
        </div>
      </div>
    </div>
